    ...
    <section id="about" ref={ref} className="about-redesign">
      <div className="container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          ...
          <m.div variants={fadeUp} className="about-landscape-wrap">
            <img loading="lazy" decoding="async" src={aboutImage} alt="Kalp & Co Studio" className="about-landscape-img" />
          </m.div>

          {/* Identity block: image + heading/paragraph */}
          <m.div variants={fadeUp} className="about-identity-row">
            <div className="about-identity-img">
              <img loading="lazy" decoding="async" src={identityImage} alt="Brand identity" />
            </div>
          ...
          <div className="about-mvvr-grid">
            {aboutBlocks.map(block => (
              <m.div variants={fadeUp} key={block.label} className="about-mvvr-card">
                <div className="about-mvvr-img">
                  <img loading="lazy" decoding="async" src={block.img} alt={block.label} />
                </div>
